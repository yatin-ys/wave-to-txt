...
export function AuthDialog({ open, onOpenChange, initialMode = "login" }: AuthDialogProps) {
  ...
  const getDescription = () => {
    switch (mode) {
      case "login":
        return "Sign in to start transcribing your audio files";
      case "signup":
        return "Create an account to save your transcriptions and access advanced features";
      case "reset":
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-6">
          ...
          {mode !== "reset" && isGoogleAuthEnabled() && (
            <>
              <Button
                variant="outline"
                className="w-full"
